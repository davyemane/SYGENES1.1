 ...
 */
final class Version20240513225009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD student_id INT DEFAULT NULL, ADD responsable_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP student_id, DROP responsable_id');
    }
}
